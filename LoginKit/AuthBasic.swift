...
//  LoginKit
//
//  Created by Kieran Andrews on 10/07/2016.
...
class AuthBasic{
    ...
    func request(manager: Alamofire.Manager) -> Alamofire.Request {
        
        var headers = [String: String]()
        
        if let username = LoginService.user?.username, let password = LoginService.user?.password {
